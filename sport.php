<?php require '_header.php'; ?>
        ...
        <main>
            ...
            <section class="secondSectionSport">
            
                <div class="divSectionSports">
                    <article class="articleSport firstArticleSport">
                        <div class="divSecondTitleSport"><h2 class="secondTitleSportQuotidien">Indoor</h2></div>
                        <div class="blocSport blocSousSecondTitle">
                            ...
                            <a href="https://www.masalledesport.com/salle-de-sport,a,lyon?page=1"><button type="button" class="btn btn-success">En savoir plus</button></a>
                        </div>
                        ...
                        <div class="blocSport">
                            ...
                            <a href="https://www.pagesjaunes.fr/annuaire/lyon-69/arts-martiaux-clubs"><button type="button" class="btn btn-success">En savoir plus</button></a>
                        </div>
                        ...
                        <div class="blocSport">
                            ...
                            <a href="https://www.grimper.com/salle-escalade-hub-lyon"><button type="button" class="btn btn-success">En savoir plus</button></a>
                        </div>

                    </article>

                    <article class="articleSport secondArticleSport">
                        ...
                        <div class="blocSport">
                            ...
                            <a href="https://sport-u-auvergnerhonealpes.com/index.php/sports-co-lyon/"><button type="button" class="btn btn-success">En savoir plus</button></a>
                        </div>
                        <div class="blocSport blocRandonnées">
                            ...
                            <a href="https://www.lyon.fr/sport/la-pratique-du-sport-au-quotidien/skate-parcs-roller-et-terrains-outdoor"><button type="button" class="btn btn-success">En savoir plus</button></a>
                        </div>
                    </article>
                </div>
            </section>
